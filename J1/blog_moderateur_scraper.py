...
def main():
    url = "https://www.blogdumoderateur.com/ai-overviews-nouveaux-reflexes-lecture-transforment-seo/"
    data = scrape_bdm_article(url)
    if data:
        pd.DataFrame([data]).to_csv("bdm_article.csv", index=False, encoding="utf-8")
